...
SWIFT_CLASS("_TtC17running_assistant11AppDelegate")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lonLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified latLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified paceLabel;
@property (nonatomic, weak) IBOutlet UISlider * _Null_unspecified paceSlider;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified bleLabel;
...
@property (nonatomic, copy) NSString * _Nonnull locationStatus;
...
- (IBAction)dataButton:(UIButton * _Nonnull)sender;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (void)chooseLeds:(CLLocationSpeed)speed;
